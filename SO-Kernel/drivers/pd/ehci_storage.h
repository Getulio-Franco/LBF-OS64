...
// AJUSTADO: Agora recebe os ponteiros para exportar o LBA máximo e o tamanho do bloco para o Kernel
...
// SINCRONIZADO: Nomes dos parâmetros idênticos à implementação do motor de DMA Bulk no .c

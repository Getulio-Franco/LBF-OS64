...
extern void gui_process_hover(void);  // Ajuste os parâmetros se elas receberem algo
extern void gui_process_release(void);
extern void gui_process_press(void);
extern void gui_process_key(void);

...
/* --- EXTERNAL HARDWARE HAL PROTOTYPES --- */
/**
 * @brief Escreve setores diretamente no disco via HAL AHCI.
 * Declarado aqui para garantir o vínculo modular com o fat32_file.c.
 */

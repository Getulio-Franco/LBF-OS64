/**
 * ============================================================================
 * FAT32 FILE SYSTEM - HEADER (V3.3 - MBR DYNAMIC SYNC)
 * ============================================================================
 */
...
extern uint32_t fat32_partition_offset; /* Alterado de static const para extern global */

/* --- PROTÓTIPOS DE INTERFACE --- */

/**
 * @brief Inicialização e Baixo Nível (fat32_logic.c)
 */
...
/**
 * @brief Manipulação de Diretórios (fat32_dir.c)
 */
...
/**
 * @brief Manipulação de Arquivos (fat32_file.c)
 */
...
int fat32_display_file(const char* name); /* Adicionado para suportar SYS_FATCAT */
int fat32_delete_file(const char* name);  /* Adicionado para suportar SYS_FATRM */
int fat32_append_file(const char* name, uint8_t* buffer, uint32_t size);

/**
 * @brief Operações Lógicas e Busca (fat32_logic.c)
 */
